...
class PostType(models.Model):
    ...
    post_type = models.CharField(
        "게시판 타입", max_length=10, choices=POST_TYPE_CHOICES, default="General")
...
class Post(models.Model):
    ...
    post_type = models.ForeignKey(
        PostType, verbose_name="게시판 타입", on_delete=models.CASCADE)
...
class PostUpdatedLog(models.Model):
    ...
    """
    user = models.ForeignKey(
        "user.User", verbose_name="수정자", on_delete=models.CASCADE)
