...
class User(AbstractBaseUser):
    ...
    gender = models.CharField(
        "성별", max_length=20, choices=GENDER_CHOICES, default="undefined")
    age = models.IntegerField("나이", default=0)
    phone = models.CharField("폰 번호", validators=[
                             phone_validator], max_length=13, unique=True, null=True, blank=True)
